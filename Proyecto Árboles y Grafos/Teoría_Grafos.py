...
class Grafos:
    def __init__(self, ventana):
        ...
        self.ventana.title("Teoría de Grafos")
        ...
        self.fondo = Image.open(self.raiz / "imagenes" / "Portada_Grafos.png")
        ...
        self.instrucciones = Image.open(self.raiz / "imagenes" / "Teoría_Grafos.jpg")
        ...
        self.btn_redes.place(x=1270, y=720)
        tk.Label(self.ventana, text = "Redes", font=("Arial", 12), anchor="center").place(x=1275, y=690)
