...
class Referencias:
    def __init__(self, ventana):
        ...
        self.ventana.title("Referencias Bibliográficas")
        ...
        self.fondo = Image.open(self.raiz / "imagenes" / "Portada_Referencias.png")
        ...
        self.instrucciones = Image.open(self.raiz / "imagenes" / "Teoría_Referencias.jpg")
        ...
        self.btn_portada.place(x=1220, y=720)
        ...
        self.btn_redes.place(x=1295, y=720)
        tk.Label(self.ventana, text = "Redes", font=("Arial", 12), anchor="center").place(x=1300, y=690)
        ...
        self.btn_grafos.place(x=1370, y=720)
        tk.Label(self.ventana, text = "Grafos", font=("Arial", 12), anchor="center").place(x=1379, y=690)
